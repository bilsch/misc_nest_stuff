...
# China!
#
# Current relay: http://www.amazon.com/gp/product/B009AQNBJW/ref=oh_details_o00_s00_i00
# Old relay: http://www.evilmadscience.com/productsmenu/tinykitlist/544
#  - replaced the old one as it was very hacky, since I'm not using an arduino on this
#
...
begin
  ...
  Syslog.log(Syslog::LOG_ERR, "Caught exception #{e.message}")
  Syslog.log(Syslog::LOG_ERR, "Caught exception #{e.backtrace}")
end
